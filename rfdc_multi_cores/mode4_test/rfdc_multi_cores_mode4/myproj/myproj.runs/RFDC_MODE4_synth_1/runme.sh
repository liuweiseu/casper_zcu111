...
HD_PWD='/home/wei/casper/tutorials_devel/zcu111/rfdc_multi_cores/mode4_test/rfdc_multi_cores_mode4/myproj/myproj.runs/RFDC_MODE4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RFDC_MODE4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RFDC_MODE4.tcl
