...
HD_PWD='/home/wei/casper/tutorials_devel/zcu111/rfdc_multi_cores/rfdc_multi_cores_mode2/myproj/myproj.runs/RFDC_MODE2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RFDC_MODE2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RFDC_MODE2.tcl
