...
HD_PWD='/home/wei/casper/casper_mlib/tutorials_devel/zcu111/rfdc_multi_cores/mode1_test/rfdc_multi_cores_mode1/myproj/myproj.runs/RFDC_MODE1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RFDC_MODE1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RFDC_MODE1.tcl
