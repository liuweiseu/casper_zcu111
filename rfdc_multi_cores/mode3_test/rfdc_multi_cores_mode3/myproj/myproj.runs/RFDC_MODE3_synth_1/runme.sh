...
HD_PWD='/home/wei/casper/tutorials_devel/zcu111/rfdc_multi_cores/mode3_test/rfdc_multi_cores_mode3/myproj/myproj.runs/RFDC_MODE3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RFDC_MODE3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RFDC_MODE3.tcl
