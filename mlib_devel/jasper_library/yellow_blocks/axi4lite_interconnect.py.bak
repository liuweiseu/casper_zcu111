...
class axi4lite_interconnect(YellowBlock):
    ...
    def modify_top(self,top):
        ...
        # axi4l mosi signals
        inst.add_port('s_axi4lite_awaddr',  'M_AXI_awaddr[31:0]',  dir='out', width=32, parent_sig=False)
        ...
        inst.add_port('s_axi4lite_araddr',  'M_AXI_araddr[31:0]',  dir='out', width=32, parent_sig=False)
