...
HD_PWD='/home/wei/casper/casper_mlib/tutorials_devel/zcu111/raw_axi_test/onegbe_test/onegbe_test/myproj/myproj.runs/gig_ethernet_pcs_pma_autonegotiation_1000BASEX_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gig_ethernet_pcs_pma_autonegotiation_1000BASEX.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gig_ethernet_pcs_pma_autonegotiation_1000BASEX.tcl
