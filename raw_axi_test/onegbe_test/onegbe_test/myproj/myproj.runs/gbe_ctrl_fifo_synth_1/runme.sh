...
HD_PWD='/home/wei/casper/casper_mlib/tutorials_devel/zcu111/raw_axi_test/onegbe_test/onegbe_test/myproj/myproj.runs/gbe_ctrl_fifo_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log gbe_ctrl_fifo.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source gbe_ctrl_fifo.tcl
