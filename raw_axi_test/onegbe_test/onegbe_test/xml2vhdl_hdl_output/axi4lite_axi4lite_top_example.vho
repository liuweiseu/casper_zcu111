...
begin
   ...
   axi4lite_bitfield_snapshot_ss_bram_inst: entity work.axi4lite_bitfield_snapshot_ss_bram
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
   ...
   axi4lite_one_gbe_inst: entity work.axi4lite_one_gbe
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
      axi4lite_mosi => axi4lite_mosi_arr(axi4lite_mmap_get_id(id_one_gbe)),
      axi4lite_miso => axi4lite_miso_arr(axi4lite_mmap_get_id(id_one_gbe))
   );
