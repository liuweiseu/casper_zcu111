...
*/
  ...
  wire [31:0] m_axi4lite_one_gbe_araddr;
  wire m_axi4lite_one_gbe_arready;
  wire m_axi4lite_one_gbe_arvalid;
  wire [31:0] m_axi4lite_one_gbe_awaddr;
  wire m_axi4lite_one_gbe_awready;
  wire m_axi4lite_one_gbe_awvalid;
  wire m_axi4lite_one_gbe_bready;
  wire [1:0] m_axi4lite_one_gbe_bresp;
  wire m_axi4lite_one_gbe_bvalid;
  wire [31:0] m_axi4lite_one_gbe_rdata;
  wire m_axi4lite_one_gbe_rready;
  wire [1:0] m_axi4lite_one_gbe_rresp;
  wire m_axi4lite_one_gbe_rvalid;
  wire [31:0] m_axi4lite_one_gbe_wdata;
  wire m_axi4lite_one_gbe_wready;
  wire [3:0] m_axi4lite_one_gbe_wstrb;
  wire m_axi4lite_one_gbe_wvalid;
  ...
  wire onegbe_test_one_gbe_wb_cyc;
  wire onegbe_test_one_gbe_wb_stb;
  wire onegbe_test_one_gbe_wb_we;
  wire onegbe_test_one_gbewb_ack;
  wire [31:0] onegbe_test_one_gbewb_adr;
  wire [31:0] onegbe_test_one_gbewb_dat_i;
  wire [31:0] onegbe_test_one_gbewb_dat_o;
  wire onegbe_test_one_gbewb_err;
  wire onegbe_test_one_gbewb_rst;
  wire [3:0] onegbe_test_one_gbewb_sel;
  wire rst_125_out;
  wire sys_rst;
  ...
  wire [12:0] onegbe_test_bitfield_snapshot_ss_bram_addr;
...
*/
  ...
  gbe_udp #(
    ...
    .wb_ack_o(onegbe_test_one_gbewb_ack),
    .wb_adr_i(onegbe_test_one_gbewb_adr),
    .wb_clk_i(axil_clk),
    .wb_cyc_i(onegbe_test_one_gbe_wb_cyc),
    .wb_dat_i(onegbe_test_one_gbewb_dat_i),
    .wb_dat_o(onegbe_test_one_gbewb_dat_o),
    .wb_err_o(onegbe_test_one_gbewb_err),
    .wb_rst_i(onegbe_test_one_gbewb_rst),
    .wb_sel_i(onegbe_test_one_gbewb_sel),
    .wb_stb_i(onegbe_test_one_gbe_wb_stb),
    .wb_we_i(onegbe_test_one_gbe_wb_we)
  );
  ...
  axi_slave_wishbone_classic_master #(
  ...
  ) onegbe_test_one_gbe_wb2axi4lite (
    .ACK_I(onegbe_test_one_gbewb_ack),
    .ADR_O(onegbe_test_one_gbewb_adr),
    .CYC_O(onegbe_test_one_gbe_wb_cyc),
    .DAT_I(onegbe_test_one_gbewb_dat_o),
    .DAT_O(onegbe_test_one_gbewb_dat_i),
    .RST_O(onegbe_test_one_gbewb_rst),
    .SEL_O(onegbe_test_one_gbewb_sel),
    .STB_O(onegbe_test_one_gbe_wb_stb),
    .S_AXI_ACLK(axil_clk),
    .S_AXI_ARADDR(m_axi4lite_one_gbe_araddr),
    .S_AXI_ARBURST(2'b01),
    .S_AXI_ARCACHE(0),
    ...
    .S_AXI_ARPROT(0),
    .S_AXI_ARQOS(0),
    .S_AXI_ARREADY(m_axi4lite_one_gbe_arready),
    .S_AXI_ARREGION(0),
    .S_AXI_ARSIZE(3'b010),
    .S_AXI_ARUSER(0),
    .S_AXI_ARVALID(m_axi4lite_one_gbe_arvalid),
    .S_AXI_AWADDR(m_axi4lite_one_gbe_awaddr),
    .S_AXI_AWBURST(2'b01),
    .S_AXI_AWCACHE(0),
    .S_AXI_AWID(0),
    .S_AXI_AWLEN(0),
    ...
    .S_AXI_AWPROT(0),
    .S_AXI_AWQOS(0),
    .S_AXI_AWREADY(m_axi4lite_one_gbe_awready),
    .S_AXI_AWREGION(0),
    .S_AXI_AWSIZE(3'b010),
    .S_AXI_AWUSER(0),
    .S_AXI_AWVALID(m_axi4lite_one_gbe_awvalid),
    .S_AXI_BID(),
    .S_AXI_BREADY(m_axi4lite_one_gbe_bready),
    .S_AXI_BRESP(m_axi4lite_one_gbe_bresp),
    .S_AXI_BUSER(),
    .S_AXI_BVALID(m_axi4lite_one_gbe_bvalid),
    .S_AXI_RDATA(m_axi4lite_one_gbe_rdata),
    .S_AXI_RID(),
    .S_AXI_RLAST(),
    .S_AXI_RREADY(m_axi4lite_one_gbe_rready),
    .S_AXI_RRESP(m_axi4lite_one_gbe_rresp),
    .S_AXI_RUSER(),
    .S_AXI_RVALID(m_axi4lite_one_gbe_rvalid),
    .S_AXI_WDATA(m_axi4lite_one_gbe_wdata),
    .S_AXI_WLAST(1'b1),
    .S_AXI_WREADY(m_axi4lite_one_gbe_wready),
    .S_AXI_WSTRB(m_axi4lite_one_gbe_wstrb),
    .S_AXI_WUSER(0),
    .S_AXI_WVALID(m_axi4lite_one_gbe_wvalid),
    .WE_O(onegbe_test_one_gbe_wb_we)
  );
  ...
  axi4lite_ic_wrapper  axi4lite_interconnect (
    ...
    .m_axi4lite_one_gbe_araddr(m_axi4lite_one_gbe_araddr),
    .m_axi4lite_one_gbe_arready(m_axi4lite_one_gbe_arready),
    .m_axi4lite_one_gbe_arvalid(m_axi4lite_one_gbe_arvalid),
    .m_axi4lite_one_gbe_awaddr(m_axi4lite_one_gbe_awaddr),
    .m_axi4lite_one_gbe_awready(m_axi4lite_one_gbe_awready),
    .m_axi4lite_one_gbe_awvalid(m_axi4lite_one_gbe_awvalid),
    .m_axi4lite_one_gbe_bready(m_axi4lite_one_gbe_bready),
    .m_axi4lite_one_gbe_bresp(m_axi4lite_one_gbe_bresp),
    .m_axi4lite_one_gbe_bvalid(m_axi4lite_one_gbe_bvalid),
    .m_axi4lite_one_gbe_rdata(m_axi4lite_one_gbe_rdata),
    .m_axi4lite_one_gbe_rready(m_axi4lite_one_gbe_rready),
    .m_axi4lite_one_gbe_rresp(m_axi4lite_one_gbe_rresp),
    .m_axi4lite_one_gbe_rvalid(m_axi4lite_one_gbe_rvalid),
    .m_axi4lite_one_gbe_wdata(m_axi4lite_one_gbe_wdata),
    .m_axi4lite_one_gbe_wready(m_axi4lite_one_gbe_wready),
    .m_axi4lite_one_gbe_wstrb(m_axi4lite_one_gbe_wstrb),
    .m_axi4lite_one_gbe_wvalid(m_axi4lite_one_gbe_wvalid),
