...
begin
   ...
   axi4lite_raw_from_processor_inst: entity work.axi4lite_raw_from_processor
   port map(
      axi4lite_aclk => axi4lite_aclk,
      axi4lite_aresetn => axi4lite_aresetn,
      axi4lite_mosi => axi4lite_mosi_arr(axi4lite_mmap_get_id(id_raw_from_processor)),
      axi4lite_miso => axi4lite_miso_arr(axi4lite_mmap_get_id(id_raw_from_processor))
   );
