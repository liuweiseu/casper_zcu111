...
HD_PWD='/home/wei/casper/casper_mlib/tutorials_devel/zcu111/rfdc_multi_adc_cores/mode4/2048GSps_MTS/rfdc_multi_eight_adcs_2048gsps_mts/myproj/myproj.runs/ADC8_R2R_MTS_2048_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC8_R2R_MTS_2048.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC8_R2R_MTS_2048.tcl
