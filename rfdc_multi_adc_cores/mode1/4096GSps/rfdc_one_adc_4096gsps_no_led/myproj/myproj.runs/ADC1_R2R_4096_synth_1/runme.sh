...
HD_PWD='/home/wei/casper/casper_mlib/tutorials_devel/zcu111/rfdc_multi_adc_cores/mode1/4096GSps/rfdc_one_adc_4096gsps_no_led/myproj/myproj.runs/ADC1_R2R_4096_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC1_R2R_4096.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC1_R2R_4096.tcl
