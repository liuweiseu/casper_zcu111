...
set_property IOSTANDARD LVCMOS18 [get_ports rfdc_one_adc_2048gsps_gpio_led_ext[0]]
set_property PACKAGE_PIN AV15 [get_ports rfdc_one_adc_2048gsps_gpio_led1_ext[0]]
set_property IOSTANDARD LVCMOS18 [get_ports rfdc_one_adc_2048gsps_gpio_led1_ext[0]]
...
set_max_delay 1.0 -to [get_ports {rfdc_one_adc_2048gsps_gpio_led_ext[*]}]
set_max_delay 1.0 -to [get_ports {rfdc_one_adc_2048gsps_gpio_led1_ext[*]}]
...
set_false_path -to [get_ports {rfdc_one_adc_2048gsps_gpio_led_ext[*]}]
set_false_path -to [get_ports {rfdc_one_adc_2048gsps_gpio_led1_ext[*]}]
