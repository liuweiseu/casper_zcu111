-- Generated from Simulink block rfdc_one_adc_2048gsps/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x5 is
  port (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  delay : entity xil_defaultlib.rfdc_one_adc_2048gsps_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  inverter : entity xil_defaultlib.sysgen_inverter_41561945ef 
  port map (
    clr => '0',
  ...
  edge_op : entity xil_defaultlib.sysgen_logical_d706590e48 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/gpio_led
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_gpio_led is
  port (
...
begin
  ...
  rfdc_one_adc_2048gsps_gpio_led_gateway <= convert_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  convert : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 1,
    din_arith => 1,
    din_bin_pt => 0,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/gpio_led1
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_gpio_led1 is
  port (
    gpio_out : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/led_cntrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_led_cntrl is
  port (
...
begin
  ...
  io_delay : entity xil_defaultlib.sysgen_delay_87ea187cfa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_led_cntrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_led_cntrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/reg_cntrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_reg_cntrl is
  port (
...
begin
  ...
  port map (
    ...
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_reg_cntrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_rst_cntrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/rfdc_V0_3
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_rfdc_v0_3 is
  port (
...
end rfdc_one_adc_2048gsps_rfdc_v0_3;
architecture structural of rfdc_one_adc_2048gsps_rfdc_v0_3 is 
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_buscreate_x1 is
  port (
...
begin
  ...
  concatenate : entity xil_defaultlib.sysgen_concat_2e3226169c 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_90766122b1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_90766122b1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x4 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
end rfdc_one_adc_2048gsps_edge_detect_x4;
...
begin
  ...
  edge_op : entity xil_defaultlib.sysgen_logical_9bba3b39ac 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_add_gen_x1 is
  port (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x4 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  concat : entity xil_defaultlib.sysgen_concat_12eee599b6 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay : entity xil_defaultlib.sysgen_delay_09b9d41af9 
  port map (
    clr => '0',
    d => delay4_q_net,
    clk => clk_net,
  ...
  delay1 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.sysgen_delay_09b9d41af9 
  port map (
    clr => '0',
    d => never_op_net,
    clk => clk_net,
  ...
  delay4 : entity xil_defaultlib.sysgen_delay_09b9d41af9 
  port map (
    clr => '0',
    d => edge_op_y_net,
    clk => clk_net,
  ...
  delay6 : entity xil_defaultlib.sysgen_delay_313f41cc8e 
  port map (
    clr => '0',
    d => data_choice_y_net,
    clk => clk_net,
  ...
  inverter : entity xil_defaultlib.sysgen_inverter_d5728413a0 
  port map (
    clr => '0',
    ip => register5_q_net,
    clk => clk_net,
  ...
  inverter1 : entity xil_defaultlib.sysgen_inverter_41561945ef 
  port map (
    clr => '0',
    ip => edge_op_y_net_x0,
    clk => clk_net,
  ...
  logical1 : entity xil_defaultlib.sysgen_logical_245bb9a37b 
  port map (
    clr => '0',
    d0 => we_choice_y_net,
    d1 => register6_q_net,
  ...
  logical4 : entity xil_defaultlib.sysgen_logical_c0c84a5e40 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical6 : entity xil_defaultlib.sysgen_logical_a0a8b90283 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  register5 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 1,
    init_value => b"1"
  )
  ...
  shift : entity xil_defaultlib.sysgen_shift_2d9f3f7190 
  port map (
    clr => '0',
    ip => convert_dout_net,
    clk => clk_net,
  ...
  add_gen : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlcounter_free 
  generic map (
    core_name0 => "rfdc_one_adc_2048gsps_c_counter_binary_v12_0_i1",
    op_arith => xlUnsigned,
    op_width => 13
  )
  port map (
  ...
  slice1 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 11,
    x_width => 13,
  ...
  slice2 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 11,
    x_width => 13,
  ...
  slice3 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 12,
    new_msb => 12,
    x_width => 13,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_dram_munge_x1 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  concat : entity xil_defaultlib.sysgen_concat_b03af149db 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  concat1 : entity xil_defaultlib.sysgen_concat_b03af149db 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_6c8388c2c7 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  logical : entity xil_defaultlib.sysgen_logical_245bb9a37b 
  port map (
    clr => '0',
  ...
  logical1 : entity xil_defaultlib.sysgen_logical_c0c84a5e40 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_e471d11323 
  port map (
    clr => '0',
  ...
  register_x0 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 32,
  ...
  register1 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register2 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  register3 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 32,
    init_value => b"00000000000000000000000000000000"
  )
  ...
  relational : entity xil_defaultlib.sysgen_relational_73c817e28d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational1 : entity xil_defaultlib.sysgen_relational_73c817e28d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational2 : entity xil_defaultlib.sysgen_relational_73c817e28d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  relational3 : entity xil_defaultlib.sysgen_relational_73c817e28d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  con0 : entity xil_defaultlib.sysgen_constant_a237949d87 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  con1 : entity xil_defaultlib.sysgen_constant_e6246ace54 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  con2 : entity xil_defaultlib.sysgen_constant_a06583c139 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  con3 : entity xil_defaultlib.sysgen_constant_fbdca4ae3b 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  data_choice : entity xil_defaultlib.sysgen_mux_94803e407d 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  dout_count : entity xil_defaultlib.sysgen_counter_392f2e56ba 
  port map (
    clr => '0',
    rst => edge_op_y_net,
    en => logical1_y_net,
  ...
  dram : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  input_count : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlcounter_free 
  generic map (
    core_name0 => "rfdc_one_adc_2048gsps_c_counter_binary_v12_0_i2",
    op_arith => xlUnsigned,
    op_width => 2
  )
  port map (
  ...
  we_choice : entity xil_defaultlib.sysgen_mux_273945c461 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x3 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_basic_ctrl_x1 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
end rfdc_one_adc_2048gsps_basic_ctrl_x1;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.rfdc_one_adc_2048gsps_dram_munge_x1 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net_x0,
  ...
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x3 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  constant_x0 : entity xil_defaultlib.sysgen_constant_8c1e959e59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant1 : entity xil_defaultlib.sysgen_constant_8c1e959e59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  constant2 : entity xil_defaultlib.sysgen_constant_8c1e959e59 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  delay2 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  delay3 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xldelay 
  generic map (
    latency => 1,
    reg_retiming => 0,
    reset => 0,
  ...
  logical : entity xil_defaultlib.sysgen_logical_5d1ff879f3 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux1 : entity xil_defaultlib.sysgen_mux_273945c461 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  mux2 : entity xil_defaultlib.sysgen_mux_273945c461 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  register6 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlregister 
  generic map (
    d_width => 1,
    init_value => b"0"
  )
  ...
  enable : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 32,
  ...
  trig_src : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 1,
    new_msb => 1,
    x_width => 32,
  ...
  valid_src : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 2,
    new_msb => 2,
    x_width => 32,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_sub : entity xil_defaultlib.sysgen_addsub_e1e12b5db2 
  port map (
    clr => '0',
    a => const_op_net,
    b => lsw_y_net,
  ...
  concat : entity xil_defaultlib.sysgen_concat_0d051a6aa7 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  const : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  convert_addr : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  lsw : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 0,
    x_width => 10,
  ...
  manipulate : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  msw : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 1,
    new_msb => 9,
    x_width => 10,
  ...
  mux : entity xil_defaultlib.sysgen_mux_596de1d603 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_munge_in_x2 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    dout : out std_logic_vector( 32-1 downto 0 )
  );
end rfdc_one_adc_2048gsps_munge_in_x2;
architecture structural of rfdc_one_adc_2048gsps_munge_in_x2 is 
...
begin
  ...
  dat_del_q_net <= din;
  reinterpret_out : entity xil_defaultlib.sysgen_reinterpret_4dbaa0ea1e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_bram_x1 is
  port (
...
begin
  ...
  we_del_q_net <= we;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_in <= convert_din1_dout_net;
  ...
  munge_in : entity xil_defaultlib.rfdc_one_adc_2048gsps_munge_in_x2 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
  ...
  convert_din1 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  convert_we : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_x2 is
  port (
...
begin
  ...
  rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out;
  io_delay : entity xil_defaultlib.sysgen_delay_87ea187cfa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 0,
    new_msb => 31,
    x_width => 32,
  ...
  reint1 : entity xil_defaultlib.sysgen_reinterpret_4dbaa0ea1e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_combine_x2 is
  port (
...
begin
  ...
  arm_or_y_net <= in4;
  concatenate : entity xil_defaultlib.sysgen_concat_f70035738e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret1 : entity xil_defaultlib.sysgen_reinterpret_0d742abc8f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_005691109f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret3 : entity xil_defaultlib.sysgen_reinterpret_594fe4cfe1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_005691109f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_split_x2 is
  port (
...
begin
  ...
  reinterpret2 : entity xil_defaultlib.sysgen_reinterpret_594fe4cfe1 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reinterpret4 : entity xil_defaultlib.sysgen_reinterpret_0d742abc8f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  slice4 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 4,
    new_msb => 31,
    x_width => 32,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_status_x2 is
  port (
...
end rfdc_one_adc_2048gsps_status_x2;
...
begin
  ...
  cast_gw : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ss_x1 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
    ...
    goto_84086191_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_84086191_we4 : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_addr : out std_logic_vector( 10-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_in : out std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_01_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  goto_84086191_we1 <= we_choice_y_net;
  goto_84086191_we4 <= logical6_y_net;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_we <= convert_we_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.rfdc_one_adc_2048gsps_add_gen_x1 
  port map (
  ...
  basic_ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_basic_ctrl_x1 
  port map (
    din => cast_dout_net,
  ...
  bram : entity xil_defaultlib.rfdc_one_adc_2048gsps_bram_x1 
  port map (
    addr => add_del_q_net,
  ...
  ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_x2 
  port map (
    rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out => rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out_net,
    in_reg => reint1_output_port_net
  );
  ctrl_combine : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_combine_x2 
  port map (
  ...
  ctrl_split : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_split_x2 
  port map (
  ...
  status : entity xil_defaultlib.rfdc_one_adc_2048gsps_status_x2 
  port map (
  ...
  add_del : entity xil_defaultlib.sysgen_delay_2cd34ca17e 
  port map (
    clr => '0',
    d => slice2_y_net,
    clk => clk_net,
  ...
  arm : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  arm_or : entity xil_defaultlib.sysgen_logical_c0c84a5e40 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  cast : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlconvert 
  generic map (
    bool_conversion => 0,
    din_arith => 1,
    din_bin_pt => 0,
  ...
  circ : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  circ_or : entity xil_defaultlib.sysgen_logical_c0c84a5e40 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  dat_del : entity xil_defaultlib.sysgen_delay_313f41cc8e 
  port map (
    clr => '0',
    d => delay6_q_net,
    clk => clk_net,
  ...
  never : entity xil_defaultlib.sysgen_constant_e390c91092 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  ri : entity xil_defaultlib.sysgen_reinterpret_4dbaa0ea1e 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  we_del : entity xil_defaultlib.sysgen_delay_09b9d41af9 
  port map (
    clr => '0',
    d => logical6_y_net,
    clk => clk_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_01
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_snapshot0_01 is
  port (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.rfdc_one_adc_2048gsps_buscreate_x1 
  port map (
    in1 => assert_d0_dout_net,
    in2 => assert_d1_dout_net,
    bus_out => concatenate_y_net
  );
  ss : entity xil_defaultlib.rfdc_one_adc_2048gsps_ss_x1 
  port map (
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_buscreate_x2 is
  port (
    in1 : in std_logic_vector( 16-1 downto 0 );
    in2 : in std_logic_vector( 16-1 downto 0 );
    bus_out : out std_logic_vector( 32-1 downto 0 )
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x7 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_add_gen_x2 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    go : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x7 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_dram_munge_x2 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x6 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_basic_ctrl_x2 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.rfdc_one_adc_2048gsps_dram_munge_x2 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net_x0,
  ...
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x6 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_munge_in_x1 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    dout : out std_logic_vector( 32-1 downto 0 )
  );
end rfdc_one_adc_2048gsps_munge_in_x1;
architecture structural of rfdc_one_adc_2048gsps_munge_in_x1 is 
  signal reinterpret_out_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 32-1 downto 0 );
begin
  dout <= reinterpret_out_output_port_net;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_bram_x2 is
  port (
    addr : in std_logic_vector( 10-1 downto 0 );
    data_in : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  dat_del_q_net <= data_in;
  we_del_q_net <= we;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_addr <= convert_addr_dout_net;
  ...
  munge_in : entity xil_defaultlib.rfdc_one_adc_2048gsps_munge_in_x1 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  ...
  port map (
    ...
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_snapshot0_23_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_split is
  port (
    bus_in : in std_logic_vector( 32-1 downto 0 );
    msb_out4 : out std_logic_vector( 28-1 downto 0 );
    out3 : out std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_status is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ss_x2 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
    ...
    ce_1 : in std_logic;
    arm_out : out std_logic_vector( 1-1 downto 0 );
    goto_85992815_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_85992815_we4 : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_addr : out std_logic_vector( 10-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_data_in : out std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_23_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  rfdc_v0_3_rfdc_v0_3_adc0_sync_net <= we;
  edge_op_y_net_x0 <= trig;
  goto_85992815_we1 <= we_choice_y_net;
  goto_85992815_we4 <= logical6_y_net;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_we <= convert_we_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_23_ss_ctrl_user_data_out;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.rfdc_one_adc_2048gsps_add_gen_x2 
  port map (
    din => data_choice_y_net,
    we => we_choice_y_net,
    go => register6_q_net,
  ...
  basic_ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_basic_ctrl_x2 
  port map (
    din => cast_dout_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net_x0,
  ...
  bram : entity xil_defaultlib.rfdc_one_adc_2048gsps_bram_x2 
  port map (
    addr => add_del_q_net,
    data_in => dat_del_q_net,
    we => we_del_q_net,
  ...
  ctrl_split : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_split 
  port map (
    bus_in => reint1_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => slice3_y_net,
  ...
  status : entity xil_defaultlib.rfdc_one_adc_2048gsps_status 
  port map (
    out_reg => concat_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_23
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_snapshot0_23 is
  port (
    in_d0 : in std_logic_vector( 16-1 downto 0 );
    in_d1 : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.rfdc_one_adc_2048gsps_buscreate_x2 
  port map (
    in1 => assert_d0_dout_net,
    in2 => assert_d1_dout_net,
    bus_out => concatenate_y_net
  );
  ss : entity xil_defaultlib.rfdc_one_adc_2048gsps_ss_x2 
  port map (
    din => concatenate_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_buscreate is
  port (
    in1 : in std_logic_vector( 16-1 downto 0 );
    in2 : in std_logic_vector( 16-1 downto 0 );
    bus_out : out std_logic_vector( 32-1 downto 0 )
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x0 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_add_gen is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    go : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x0 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_dram_munge is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_basic_ctrl is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.rfdc_one_adc_2048gsps_dram_munge 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net_x0,
  ...
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_calc_add is
  port (
    in_x0 : in std_logic_vector( 10-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_munge_in is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    dout : out std_logic_vector( 32-1 downto 0 )
  );
end rfdc_one_adc_2048gsps_munge_in;
architecture structural of rfdc_one_adc_2048gsps_munge_in is 
  signal reinterpret_out_output_port_net : std_logic_vector( 32-1 downto 0 );
  signal dat_del_q_net : std_logic_vector( 32-1 downto 0 );
begin
  dout <= reinterpret_out_output_port_net;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_bram is
  port (
    addr : in std_logic_vector( 10-1 downto 0 );
    data_in : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  dat_del_q_net <= data_in;
  we_del_q_net <= we;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_addr <= convert_addr_dout_net;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  calc_add : entity xil_defaultlib.rfdc_one_adc_2048gsps_calc_add 
  port map (
    in_x0 => add_del_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  munge_in : entity xil_defaultlib.rfdc_one_adc_2048gsps_munge_in 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
begin
  in_reg <= reint1_output_port_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out;
  io_delay : entity xil_defaultlib.sysgen_delay_87ea187cfa 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_split_x1 is
  port (
    bus_in : in std_logic_vector( 32-1 downto 0 );
    msb_out4 : out std_logic_vector( 28-1 downto 0 );
    out3 : out std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_status_x1 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ss is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
    ...
    ce_1 : in std_logic;
    arm_out : out std_logic_vector( 1-1 downto 0 );
    goto_87899439_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_87899439_we4 : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_addr : out std_logic_vector( 10-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_data_in : out std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_45_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  rfdc_v0_3_rfdc_v0_3_adc0_sync_net <= we;
  edge_op_y_net_x0 <= trig;
  goto_87899439_we1 <= we_choice_y_net;
  goto_87899439_we4 <= logical6_y_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_we <= convert_we_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.rfdc_one_adc_2048gsps_add_gen 
  port map (
    din => data_choice_y_net,
    we => we_choice_y_net,
    go => register6_q_net,
  ...
  basic_ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_basic_ctrl 
  port map (
    din => cast_dout_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net_x0,
  ...
  bram : entity xil_defaultlib.rfdc_one_adc_2048gsps_bram 
  port map (
    addr => add_del_q_net,
    data_in => dat_del_q_net,
    we => we_del_q_net,
  ...
  ctrl_split : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_split_x1 
  port map (
    bus_in => reint1_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => slice3_y_net,
  ...
  status : entity xil_defaultlib.rfdc_one_adc_2048gsps_status_x1 
  port map (
    out_reg => concat_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_45
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_snapshot0_45 is
  port (
    in_d0 : in std_logic_vector( 16-1 downto 0 );
    in_d1 : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.rfdc_one_adc_2048gsps_buscreate 
  port map (
    in1 => assert_d0_dout_net,
    in2 => assert_d1_dout_net,
    bus_out => concatenate_y_net
  );
  ss : entity xil_defaultlib.rfdc_one_adc_2048gsps_ss 
  port map (
    din => concatenate_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/buscreate
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_buscreate_x0 is
  port (
    in1 : in std_logic_vector( 16-1 downto 0 );
    in2 : in std_logic_vector( 16-1 downto 0 );
    bus_out : out std_logic_vector( 32-1 downto 0 )
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/add_gen/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x2 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/add_gen
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_add_gen_x0 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    go : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x2 
  port map (
    in_x0 => slice3_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/basic_ctrl/dram_munge
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_dram_munge_x0 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    init : in std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/basic_ctrl/edge_detect
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_edge_detect_x1 is
  port (
    in_x0 : in std_logic_vector( 1-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/basic_ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_basic_ctrl_x0 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  dram_munge : entity xil_defaultlib.rfdc_one_adc_2048gsps_dram_munge_x0 
  port map (
    din => cast_dout_net,
    we => mux1_y_net,
    init => edge_op_y_net_x0,
  ...
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x1 
  port map (
    in_x0 => delay1_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/bram/calc_add
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_calc_add_x0 is
  port (
    in_x0 : in std_logic_vector( 10-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/bram/munge_in
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_munge_in_x0 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    dout : out std_logic_vector( 32-1 downto 0 )
  );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/bram
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_bram_x0 is
  port (
    addr : in std_logic_vector( 10-1 downto 0 );
    data_in : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  dat_del_q_net <= data_in;
  we_del_q_net <= we;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_we <= convert_we_dout_net;
  clk_net <= clk_1;
  ce_net <= ce_1;
  calc_add : entity xil_defaultlib.rfdc_one_adc_2048gsps_calc_add_x0 
  port map (
    in_x0 => add_del_q_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
  ...
  munge_in : entity xil_defaultlib.rfdc_one_adc_2048gsps_munge_in_x0 
  port map (
    din => dat_del_q_net,
    dout => reinterpret_out_output_port_net
  );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/ctrl
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_x1 is
  port (
...
begin
  ...
  port map (
    ...
    ce => '0',
    clr => '0',
    d => rfdc_one_adc_2048gsps_snapshot0_67_ss_ctrl_user_data_out_net,
    q => io_delay_q_net
  );
  slice_reg : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/ctrl_combine
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/ctrl_split
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ctrl_split_x0 is
  port (
    bus_in : in std_logic_vector( 32-1 downto 0 );
    msb_out4 : out std_logic_vector( 28-1 downto 0 );
    out3 : out std_logic_vector( 1-1 downto 0 );
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss/status
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_status_x0 is
  port (
    out_reg : in std_logic_vector( 32-1 downto 0 );
    clk_1 : in std_logic;
    ce_1 : in std_logic;
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67/ss
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_ss_x0 is
  port (
    din : in std_logic_vector( 32-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
    trig : in std_logic_vector( 1-1 downto 0 );
    ...
    ce_1 : in std_logic;
    arm_out : out std_logic_vector( 1-1 downto 0 );
    goto_89806063_we1 : out std_logic_vector( 1-1 downto 0 );
    goto_89806063_we4 : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_addr : out std_logic_vector( 10-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_in : out std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_we : out std_logic_vector( 1-1 downto 0 );
    rfdc_one_adc_2048gsps_snapshot0_67_ss_status_user_data_in : out std_logic_vector( 32-1 downto 0 )
...
begin
  ...
  rfdc_v0_3_rfdc_v0_3_adc0_sync_net <= we;
  edge_op_y_net_x0 <= trig;
  goto_89806063_we1 <= we_choice_y_net;
  goto_89806063_we4 <= logical6_y_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_we <= convert_we_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_67_ss_ctrl_user_data_out;
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  add_gen : entity xil_defaultlib.rfdc_one_adc_2048gsps_add_gen_x0 
  port map (
    din => data_choice_y_net,
    we => we_choice_y_net,
    go => register6_q_net,
  ...
  basic_ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_basic_ctrl_x0 
  port map (
    din => cast_dout_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net_x0,
  ...
  bram : entity xil_defaultlib.rfdc_one_adc_2048gsps_bram_x0 
  port map (
    addr => add_del_q_net,
    data_in => dat_del_q_net,
    we => we_del_q_net,
  ...
  ctrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_x1 
  port map (
  ...
  ctrl_split : entity xil_defaultlib.rfdc_one_adc_2048gsps_ctrl_split_x0 
  port map (
    bus_in => reint1_output_port_net,
    msb_out4 => reinterpret4_output_port_net,
    out3 => slice3_y_net,
  ...
  status : entity xil_defaultlib.rfdc_one_adc_2048gsps_status_x0 
  port map (
    out_reg => concat_y_net,
    clk_1 => clk_net,
    ce_1 => ce_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/snapshot0_67
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_snapshot0_67 is
  port (
    in_d0 : in std_logic_vector( 16-1 downto 0 );
    in_d1 : in std_logic_vector( 16-1 downto 0 );
    we : in std_logic_vector( 1-1 downto 0 );
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  buscreate : entity xil_defaultlib.rfdc_one_adc_2048gsps_buscreate_x0 
  port map (
    in1 => assert_d0_dout_net,
    in2 => assert_d1_dout_net,
    bus_out => concatenate_y_net
  );
  ss : entity xil_defaultlib.rfdc_one_adc_2048gsps_ss_x0 
  port map (
    din => concatenate_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    trig => edge_op_y_net,
...
-- Generated from Simulink block rfdc_one_adc_2048gsps/sync_state
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_sync_state is
  port (
...
begin
  ...
  clk_net <= clk_1;
  ce_net <= ce_1;
  io_delay : entity xil_defaultlib.sysgen_delay_6c99f3d9dc 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
  ...
  reint1 : entity xil_defaultlib.sysgen_reinterpret_005691109f 
  port map (
    clk => '0',
    ce => '0',
    clr => '0',
...
-- Generated from Simulink block rfdc_one_adc_2048gsps_struct
library IEEE;
use IEEE.std_logic_1164.all;
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_struct is
  port (
    rfdc_one_adc_2048gsps_led_cntrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_reg_cntrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    rfdc_v0_3_rfdc_v0_3_adc0_dout : in std_logic_vector( 128-1 downto 0 );
...
begin
  ...
  rfdc_v0_3_rfdc_v0_3_adc0_dout_net <= rfdc_v0_3_rfdc_v0_3_adc0_dout;
  rfdc_v0_3_rfdc_v0_3_adc0_sync_net <= rfdc_v0_3_rfdc_v0_3_adc0_sync;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_addr <= convert_addr_dout_net_x2;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_in <= convert_din1_dout_net_x2;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_data_out;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_we <= convert_we_dout_net_x2;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_01_ss_ctrl_user_data_out;
  rfdc_one_adc_2048gsps_snapshot0_01_ss_status_user_data_in <= cast_gw_dout_net_x2;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_addr <= convert_addr_dout_net_x1;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_data_in <= convert_din1_dout_net_x1;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_data_out;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_we <= convert_we_dout_net_x1;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_23_ss_ctrl_user_data_out;
  rfdc_one_adc_2048gsps_snapshot0_23_ss_status_user_data_in <= cast_gw_dout_net_x3;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_addr <= convert_addr_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_data_in <= convert_din1_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_data_out;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_bram_we <= convert_we_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_45_ss_ctrl_user_data_out;
  rfdc_one_adc_2048gsps_snapshot0_45_ss_status_user_data_in <= cast_gw_dout_net;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_addr <= convert_addr_dout_net_x0;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_in <= convert_din1_dout_net_x0;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_data_out;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_we <= convert_we_dout_net_x0;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_ctrl_user_data_out_net <= rfdc_one_adc_2048gsps_snapshot0_67_ss_ctrl_user_data_out;
  rfdc_one_adc_2048gsps_snapshot0_67_ss_status_user_data_in <= cast_gw_dout_net_x0;
  rfdc_one_adc_2048gsps_sync_state_user_data_in <= cast_gw_dout_net_x1;
  clk_net <= clk_1;
  ce_net <= ce_1;
  edge_detect : entity xil_defaultlib.rfdc_one_adc_2048gsps_edge_detect_x5 
  port map (
  ...
  gpio_led : entity xil_defaultlib.rfdc_one_adc_2048gsps_gpio_led 
  port map (
  ...
  gpio_led1 : entity xil_defaultlib.rfdc_one_adc_2048gsps_gpio_led1 
  port map (
  ...
  led_cntrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_led_cntrl 
  port map (
    rfdc_one_adc_2048gsps_led_cntrl_user_data_out => rfdc_one_adc_2048gsps_led_cntrl_user_data_out_net,
    in_led_cntrl => slice_led_cntrl_y_net
  );
  reg_cntrl : entity xil_defaultlib.rfdc_one_adc_2048gsps_reg_cntrl 
  port map (
    rfdc_one_adc_2048gsps_reg_cntrl_user_data_out => rfdc_one_adc_2048gsps_reg_cntrl_user_data_out_net,
    in_rst_cntrl => slice_rst_cntrl_y_net
  );
  rfdc_v0_3 : entity xil_defaultlib.rfdc_one_adc_2048gsps_rfdc_v0_3 
  port map (
  ...
  snapshot0_01 : entity xil_defaultlib.rfdc_one_adc_2048gsps_snapshot0_01 
  port map (
    in_d0 => slice_y_net,
    in_d1 => slice7_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    ...
    rfdc_one_adc_2048gsps_snapshot0_01_ss_bram_we => convert_we_dout_net_x2,
    rfdc_one_adc_2048gsps_snapshot0_01_ss_status_user_data_in => cast_gw_dout_net_x2,
    goto_84086191_we1 => we_choice_y_net_x2,
    goto_84086191_we4 => logical6_y_net_x2
  );
  snapshot0_23 : entity xil_defaultlib.rfdc_one_adc_2048gsps_snapshot0_23 
  port map (
    in_d0 => slice1_y_net,
    in_d1 => slice6_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    ...
    rfdc_one_adc_2048gsps_snapshot0_23_ss_bram_we => convert_we_dout_net_x1,
    rfdc_one_adc_2048gsps_snapshot0_23_ss_status_user_data_in => cast_gw_dout_net_x3,
    goto_85992815_we1 => we_choice_y_net_x1,
    goto_85992815_we4 => logical6_y_net_x0
  );
  snapshot0_45 : entity xil_defaultlib.rfdc_one_adc_2048gsps_snapshot0_45 
  port map (
    in_d0 => slice2_y_net,
    in_d1 => slice5_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    ...
    rfdc_one_adc_2048gsps_snapshot0_45_ss_status_user_data_in => cast_gw_dout_net,
    goto_87899439_we1 => we_choice_y_net,
    goto_87899439_we4 => logical6_y_net_x1
  );
  snapshot0_67 : entity xil_defaultlib.rfdc_one_adc_2048gsps_snapshot0_67 
  port map (
    in_d0 => slice3_y_net,
    in_d1 => slice4_y_net,
    we => rfdc_v0_3_rfdc_v0_3_adc0_sync_net,
    ...
    rfdc_one_adc_2048gsps_snapshot0_67_ss_bram_we => convert_we_dout_net_x0,
    rfdc_one_adc_2048gsps_snapshot0_67_ss_status_user_data_in => cast_gw_dout_net_x0,
    goto_89806063_we1 => we_choice_y_net_x0,
    goto_89806063_we4 => logical6_y_net
  );
  sync_state : entity xil_defaultlib.rfdc_one_adc_2048gsps_sync_state 
  port map (
  ...
  slice5 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 80,
    new_msb => 95,
    x_width => 128,
  ...
  slice6 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 48,
    new_msb => 63,
    x_width => 128,
  ...
  slice7 : entity xil_defaultlib.rfdc_one_adc_2048gsps_xlslice 
  generic map (
    new_lsb => 16,
    new_msb => 31,
    x_width => 128,
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps_default_clock_driver is
  port (
    rfdc_one_adc_2048gsps_sysclk : in std_logic;
    rfdc_one_adc_2048gsps_sysce : in std_logic;
    rfdc_one_adc_2048gsps_sysclr : in std_logic;
    rfdc_one_adc_2048gsps_clk1 : out std_logic;
    rfdc_one_adc_2048gsps_ce1 : out std_logic
  );
end rfdc_one_adc_2048gsps_default_clock_driver;
architecture structural of rfdc_one_adc_2048gsps_default_clock_driver is 
begin
  ...
  port map (
    sysclk => rfdc_one_adc_2048gsps_sysclk,
    sysce => rfdc_one_adc_2048gsps_sysce,
    sysclr => rfdc_one_adc_2048gsps_sysclr,
    clk => rfdc_one_adc_2048gsps_clk1,
    ce => rfdc_one_adc_2048gsps_ce1
  );
end structural;
-- Generated from Simulink block 
library IEEE;
...
library xil_defaultlib;
use xil_defaultlib.conv_pkg.all;
entity rfdc_one_adc_2048gsps is
  port (
    rfdc_one_adc_2048gsps_led_cntrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    rfdc_one_adc_2048gsps_reg_cntrl_user_data_out : in std_logic_vector( 32-1 downto 0 );
    rfdc_v0_3_rfdc_v0_3_adc0_dout : in std_logic_vector( 128-1 downto 0 );
...
begin
  ...
  port map (
    rfdc_one_adc_2048gsps_sysclk => clk,
    rfdc_one_adc_2048gsps_sysce => '1',
    rfdc_one_adc_2048gsps_sysclr => '0',
    rfdc_one_adc_2048gsps_clk1 => clk_1_net,
    rfdc_one_adc_2048gsps_ce1 => ce_1_net
  );
  rfdc_one_adc_2048gsps_struct : entity xil_defaultlib.rfdc_one_adc_2048gsps_struct 
  port map (
