...
void mmap_io_write16(void* io,unsigned int RegOffset, unsigned int RegisterValue);
unsigned char mmap_io_read8(void* io,unsigned int RegOffset);
void mmap_io_write8(void* io,unsigned int RegOffset, unsigned int RegisterValue);
