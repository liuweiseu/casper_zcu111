...
def set_all_ref_clks(freq):
    ...
    if not freq in _lmx2594Config:
        ...
        _safe_wrapper("writeLmk04208Regs", _iic_channel, _lmk04208Config[128])
...
_lmk04208Config = {
    ...
    128: [
        0x00160040, 0x00146000, 0x00146001, 0x00140302,
        0xC0140023, 0x00140324, 0x80141E05, 0x01100006,
        0x01100007, 0x06010008, 0x55555549, 0x9102410A,
        0x0401100B, 0x1B0C006C, 0x2302886D, 0x0200000E,
        0x8000800F, 0xC1550410, 0x00000058, 0x02C9C419,
        0x8FA8001A, 0x10001E1B, 0x00201E1C, 0x0180033D,
        0x0200033E, 0x003F001F
    ]
}
